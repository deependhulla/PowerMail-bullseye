...
my $cmx="find /home/archivedata/mail-archive-uncompress/  -type f > ".$myfilelist;
...
my $cmdxpost="/usr/sbin/postcat -hb $directeml  > /home/archivedata/mail-archive-process/".$newtmpfile." ";
print "\n $cmdxpost";
